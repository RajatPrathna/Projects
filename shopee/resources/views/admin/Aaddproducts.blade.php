            ...
            <form id="addProductForm" method="POST" action="Aaddproducts" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="help-text">Enter price in USD</div>
                    </div>

                    <div class="form-group">
                        <label for="stock">Stock Quantity</label>
                        <input type="number" id="stock" name="stock" placeholder="0" min="0">
                        <div class="help-text">Leave empty for unlimited stock</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox-group">
                            <input type="checkbox" id="newProduct" name="newProduct" value="newproducts">
                            <label for="newProduct">New Product</label>
                        </div>
                        <div class="checkbox-group">
                            <input type="checkbox" id="onSale" name="onSale" value="sale">
